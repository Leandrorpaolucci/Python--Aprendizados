...
def login():
    ...
    if form_login.validate_on_submit() and 'botao_submit_login' in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, form_login.senha.data):
            ...
            flash(f'Falha no login. E-mail ou Senha incorretos, por favor tente novamente', 'alert-danger')
    ...
    if form_criarconta.validate_on_submit() and 'botao_submit_criarconta' in request.form:
        ...
        flash(f'Conta criada para o o e-mail: {form_criarconta.email.data}', 'alert-success')
        return redirect(url_for('home'))
...
def sair():
    logout_user()
    flash(f'Loggout realizado com sucesso. Faça Login para criar um post.', 'alert-success')
    return redirect(url_for('home'))
